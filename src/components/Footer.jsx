...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/corebridge',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Facebook',
      href: 'https://facebook.com/corebridge',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      href: 'https://youtube.com/corebridge',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">CoreBridge</span>
            </div>
        ...
        <div className="border-t border-slate-800 mt-8 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <div className="text-sm text-slate-400">
              © {currentYear} CoreBridge Health Solutions. All rights reserved.
            </div>
