        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <motion.div
                className="flex flex-col sm:flex-row gap-2.5 sm:gap-3 md:gap-4 justify-center lg:justify-start"
                variants={itemVariants}
              >
                <motion.a
                  href="/employer-plan"
                  className="inline-flex items-center justify-center px-4 sm:px-4 md:px-3 lg:px-4 py-2 sm:py-2.5 md:py-3 lg:py-4 bg-white text-indigo-900 font-semibold rounded-full shadow-lg hover:shadow-xl transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-white focus:ring-opacity-50 text-xs sm:text-sm md:text-base min-w-[120px] sm:min-w-[140px] md:min-w-[160px] lg:min-w-[180px]"
                ...
                >
                  <span className="text-center">Learn About Employer Plan</span>
                  <svg className="ml-1 sm:ml-1.5 md:ml-2 w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <motion.a
                  ...
                  className="inline-flex items-center justify-center px-3 sm:px-4 md:px-6 lg:px-8 py-2 sm:py-2.5 md:py-3 lg:py-4 bg-transparent text-white font-semibold rounded-full border-2 border-white hover:bg-white hover:text-indigo-900 transition-all duration-200 focus:outline-none focus:ring-4 focus:ring-white focus:ring-opacity-50 text-xs sm:text-sm md:text-base min-w-[120px] sm:min-w-[140px] md:min-w-[160px] lg:min-w-[180px]"
                  variants={buttonVariants}
                  whileHover="hover"
                  whileTap="tap"
                ...
                >
                  <span className="text-center">Explore Individual Plans</span>
                  <svg className="ml-1 sm:ml-1.5 md:ml-2 w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                  </svg>
                </motion.a>
