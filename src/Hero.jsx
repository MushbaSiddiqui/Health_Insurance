    ...
    >
      <div className="relative">
        <div className="w-32 h-40 bg-gradient-to-b from-blue-500 to-teal-500 rounded-t-full opacity-80">
          <div className="absolute inset-0 bg-gradient-to-b from-blue-400 to-teal-400 rounded-t-full scale-95" />
        </div>
...
const TrustStrip = () => (
  <div className="mt-8 text-center">
    <p className="text-sm text-gray-200/80 mb-4">Trusted by employers & families nationwide</p>
    <div className="flex justify-center items-center space-x-6">
      {[1, 2, 3, 4, 5].map((i) => (
        <div key={i} className="w-12 h-8 bg-white/20 rounded opacity-60" aria-hidden="true" />
      ))}
    </div>
  </div>
);
...
export default function Hero() {
  ...
  const buttonVariants = {
    hover: prefersReducedMotion ? {} : { scale: 1.05, y: -2, transition: { duration: 0.2 } },
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <motion.p className="text-lg sm:text-xl text-blue-100 mb-6 sm:mb-8" variants={itemVariants}>
                Offer two paths to affordable healthcare:
              </motion.p>

              <motion.ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8" variants={itemVariants}>
              ...
              <motion.p className="text-xs sm:text-sm text-gray-300/70 mb-6 sm:mb-8" variants={itemVariants}>
...
>
  ...
  <motion.a
    ...
    className="
      ...
      min-h-[44px] min-w-[140px] sm:min-w-[150px] md:min-w-[160px]
    "
  ...
  <motion.a
    ...
    className="
      ...
      focus:outline-none focus:ring-4 focus:ring-white focus:ring-opacity-50
      text-sm sm:text-base
      min-h-[44px] min-w-[140px] sm:min-w-[80px] md:min-w-[110px]
    "
    variants={buttonVariants}
    whileHover="hover"
    whileTap="tap"
  ...
  >
    ...
    >
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            ...
            {/* Right Visual */}
            <motion.div className="hidden lg:block relative order-1 lg:order-2" variants={itemVariants}>
